...
(function(){
    ...
    console.log("Non allerganes appear count = \n" + sum);
})();
// 2282

(function(){
    console.log("===== Part 2 =====");
    console.log("Canonical Dangerous Ingredients = \n" + Object.keys(definedAllergens).sort().map(allergen => definedAllergens[allergen]).join(','));
})();
