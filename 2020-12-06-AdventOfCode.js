...
(function(){
    console.log("===== Part 1 =====");
	var totalTrueQuestions = 0;
	for (var inputKey in inputs) {
		var q = inputs[inputKey];
		q = q.join("").split("").sort();
		q = [...new Set(q)];
		totalTrueQuestions += q.length ;
	}
	console.log("Total True Questions = " + totalTrueQuestions);
})();
...
(function(){
	...
	for (var inputKey in inputs) {
		var q = inputs[inputKey];
		for (var qKey in q) {
			q[qKey] = [... q[qKey].split("").sort()]
		}
		var shared = getCommonValues(q);
		if (shared) totalTrueQuestions += shared.length ;
	}
	console.log("Total Shared True Questions = " + totalTrueQuestions);
})();
